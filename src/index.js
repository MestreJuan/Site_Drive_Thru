...
app.listen(PORT, () => { console.log(`🚀 Servidor rodando em: http://localhost:${PORT}`); }); //inicia o loop do servidor como se fosse um while(1) e apenas quando conseguir ocupar a porta de destino, imprime o .log